...
<head>
    ...
    <title>Arcade-Login or Sign up</title>
...
<body>
    <main>
        <div class="row">
            <div class="colm-logo">
                <img src="table.jpg" alt="Arcade" height="300" width="450" />
                <h2>Arcade helps you reserve tables for efficient dining.</h2>
            </div>
            ...
            <div class="colm-form">
                <div class="form-container">
                    ...
                    <input type="password" placeholder="Password" name="password">
                        ...
                        ?>
                    <input class="btn-login" id="login" name="login" type="submit" value="Login">
                    <a href="#">Forgotten password?</a>
                    <a class="btn-new" href="signup.php">Create new Account</a>
