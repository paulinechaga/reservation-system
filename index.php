...
<header class="header">
   ...
   <a class="logo"><img src="pic.png" alt="logo"></a>
   </div>
        <div class="col-md-12 text-center">
...
<section id="aboutus">
 ...
 <div class="container">
   <h3 class="text-center"><br><br>Arcade</h3>
   <div class="row">
<!--carousel-->
     <div class="col-sm"><br><br>
        ...
        <div class="carousel-inner">
           ...
           <div class="carousel-item">
           <img class="d-block w-100" src="img4.jfif" alt="Third slide">
           </div>
        </div>
...
<!--end of carousel-->
	...
	<p><br>The restaurant Arcade, first opened in 2022 in “Rongai”, one of the towns of Kajiado county. In 2023 the restaraunt has been recognized due to its elegant interior design<br><br>
	This year, the restaurant relocated to the 6th floor of the Onassis Cultural Centre in maasai lodge Avenue and was recently redesigned by award-winning architectural firm Divercity.In warmer months of the year the restaurant moves
	to the 7th floor of the building, offering a unique outdoor setting with panoramic view of the hill and the skyline.<br><br><br></p><hr>
	</div>
     </div>
    </div><br>
  </div>
    ...
    <h3 class="text-center"><br>Gallery<br><br></h3>
        <div class="d-flex flex-row flex-wrap justify-content-center">
           <div class="d-flex flex-column">
              <img src="img1.jfif" class="img-fluid">
              <img src="img2.jfif" class="img-fluid">
           </div>
           <div class="d-flex flex-column">
              <img src="img3.jfif" class="img-fluid">
              <img src="img4.jfif" class="img-fluid">
           </div>
           <div class="d-flex flex-column">
               <img src="img5.jfif" class="img-fluid">
               <img src="img7.jfif" class="img-fluid">
           </div>
           <div class="d-flex flex-column">
               <img src="img10.jfif" class="img-fluid">
               <img src="img8.jfif" class="img-fluid">
           </div>
        </div>
    </div>
</div><br><br>
...
<div class="container" id="reservation">
    ...
    <img  src="img6.jfif" class="img-fluid rounded" style="width:80%">
...
?>
            ...
            <p class="text-right">Arcade<br><i class="fa fa-map-marker"></i>&nbsp; ole, Maasai lodge <br>Rongai <br><br>email: info@domain.com<br>phone: +254 726 605 7943</p>
            </div>
